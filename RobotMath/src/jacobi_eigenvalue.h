...
#ifndef JACOBI_EIGENVALUE_H_
#define JACOBI_EIGENVALUE_H_

void jacobi_eigenvalue(int n, double a[], int it_max, double v[], double d[],
		int &it_num, int &rot_num);
